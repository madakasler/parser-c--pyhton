...
static const char *const yytname[] =
    {
        "$end", "error", "$undefined", "INCLUDERE", "TIP_PRIMITIV", "VALOARE",
        ...
        "')'", "','", "'{'", "'}'", "$accept", "verificare_namespace", "$@1",
        "verificare_includere", "$@2", "verificare_clasa", "$@3",
        ...
        "verificare_body_main", "$@25", "$@26", "verificare_namespace", "$@27", YY_NULLPTR};
#endif
...
static const yytype_int16 yypact[] =
    {
        330, 4, -3, -74, 10, -74, -74, -16, 18, 20,
        -74, -74, -74, 21, 36, -74, 350, -74, -74, -74,
        28, -74, -13, -74, 26, 16, 223, -74, 250, 277,
        43, -74, -74, -74, -74, -74, -74, 350, -74, -74,
        250, 29, -74, -74, -74, -74, -74, -74, -74, -74,
        115, 223, -74, 330, -74, -74, 142, 250, -74, -74,
        -74, 169, 277, -74, 22, -74, 43, 250, -74, -74,
        250, 304, 304, 304, 304, 304, 223, 44, -74, -74,
        -74, 250, 8, -74, -74, 277, 369, -74, -74, -74,
        -74, -74, 250, -74, -74, -74, 196, 304, -74, -74,
        -74, -74, -74, -74, -74, -74, -2, -74, -74, -74,
        -74, 28, 277, -74, 304, 92, -74, -74, -74, -74,
        -74};
...
static const yytype_int8 yydefact[] =
    {
        ...
        14, 7, 35, 43, 25, 0, 15, 3, 15, 15,
        34, 45, 46, 44, 1, 9, 49, 6, 36, 29,
        15, 27, 52, 54, 58, 56, 60, 84, 88, 23,
        15, 15, 40, 2, 63, 67, 15, 15, 12, 70,
        74, 15, 15, 17, 0, 8, 34, 15, 26, 31,
        15, 15, 15, 15, 15, 15, 15, 38, 87, 86,
        4, 15, 24, 66, 65, 15, 15, 73, 72, 18,
...
static const yytype_int8 yypgoto[] =
    {
        -74, 6, -74, -5, -74, -74, -74, 5, -74, -74,
        -19, -74, -74, -74, -74, -27, -74, -73, -74, 0,
        -7, -74, -74, -74, -74, -74, -32, -74, -74, -55,
        -74, -74, 7, -74, -74, -36, -74, -74};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
    {
        -1, 14, 53, 15, 37, 16, 28, 49, 29, 112,
...
static const yytype_int8 yytable[] =
    {
        20, 22, 22, 64, 104, 17, 87, 88, 68, 108,
        23, 35, 106, 30, 78, 79, 20, 21, 38, 51,
        3, 17, 62, 27, 83, 84, 50, 24, 24, 61,
        109, 31, 65, 32, 33, 91, 34, 20, 93, 90,
        103, 36, 17, 51, 51, 39, 41, 22, 69, 105,
        50, 50, 89, 20, 62, 62, 3, 118, 17, 80,
        113, 61, 61, 107, 97, 97, 97, 97, 97, 51,
        0, 96, 96, 96, 96, 96, 50, 0, 62, 99,
        ...
        8, 9, 10, 1, 2, 11, 0, 12, 13, 0,
        0, 0, 3, -10, 0, 0, 5, 6, 7, 0,
...
static const yytype_int8 yycheck[] =
    {
        0, 4, 4, 30, 77, 0, 61, 62, 40, 82,
        13, 16, 4, 29, 50, 51, 16, 13, 31, 26,
        12, 16, 29, 13, 56, 57, 26, 30, 30, 29,
        85, 13, 37, 13, 13, 67, 0, 37, 70, 66,
        76, 13, 37, 50, 51, 19, 30, 4, 19, 81,
        50, 51, 30, 53, 61, 62, 12, 112, 53, 53,
        92, 61, 62, 82, 71, 72, 73, 74, 75, 76,
        -1, 71, 72, 73, 74, 75, 76, -1, 85, 72,
...
static const yytype_int8 yystos[] =
    {
        ...
        29, 13, 13, 13, 0, 37, 13, 38, 31, 19,
        45, 30, 7, 8, 9, 10, 23, 32, 33, 41,
        53, 54, 69, 36, 32, 33, 53, 54, 60, 32,
        33, 53, 54, 63, 49, 37, 50, 47, 60, 19,
        46, 55, 56, 58, 57, 59, 70, 71, 69, 69,
        35, 61, 62, 60, 60, 64, 65, 63, 63, 30,
...
#line 1680 "cparser.tab.c"
  break;

#line 1684 "cparser.tab.c"
